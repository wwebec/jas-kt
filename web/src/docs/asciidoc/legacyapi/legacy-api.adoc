...
= JobRoom Legacy API Documentation `Deprecated`
...
When using the API, job offers are published to *Job-Room* (https://www.job-room.ch) and *Job-Desk* (http://www.job-desk.ch).
...
include::legacy-api-create.adoc[]

== Get a job offer

include::legacy-api-get.adoc[]

== Get all job offers

include::legacy-api-getAll.adoc[]

== Edit a job offer

include::legacy-api-update.adoc[]
...
include::legacy-api-appendix.adoc[]
