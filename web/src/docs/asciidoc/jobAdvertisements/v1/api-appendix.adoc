...
| CREATED | The job advertisement was created
| INSPECTING | The job ad has been passed to AVAM system
| APPROVED | The job ad has been approved in the AVAM system
| REJECTED | The job ad has been rejected in the AVAM system
| REFINING | The job ad is waiting for refinements
| PUBLISHED_RESTRICTED | The job ad is only displayed for logged in user (cause reporting obligation)
