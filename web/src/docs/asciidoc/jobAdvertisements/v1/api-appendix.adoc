...
e.g.
```
curl -H 'Content-Type: application/json' -H 'Accept: application/json' -d @src/curl/create_job_advertisement-payload.json http://localhost:8086/api/jobAdvertisements
```
