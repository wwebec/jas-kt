    ...
    public class JWTConfig extends WebSecurityConfigurerAdapter {
        ...
        protected void configure(HttpSecurity http) throws Exception {
            ...
            .and()
                ...
                .antMatchers(HttpMethod.PATCH, "/api/jobAdvertisements/cancel/token/{token}").permitAll()
    ...
    public class OAuth2Config extends ResourceServerConfigurerAdapter {
        ...
        public void configure(HttpSecurity http) throws Exception {
            ...
            .and()
                .authorizeRequests()
                .antMatchers(HttpMethod.GET, "/api/jobAdvertisements").permitAll()
                .antMatchers(HttpMethod.POST, "/api/jobAdvertisements", "/api/_search/jobAdvertisements", "/api/_count/jobAdvertisements").permitAll()
                .antMatchers(HttpMethod.PATCH, "/api/jobAdvertisements/cancel/token/{token}").permitAll()
                .antMatchers("/api/apiUser/**").hasAuthority(AuthoritiesConstants.ADMIN)
                .antMatchers("/api/**").authenticated()
                .antMatchers("/management/info").permitAll()
