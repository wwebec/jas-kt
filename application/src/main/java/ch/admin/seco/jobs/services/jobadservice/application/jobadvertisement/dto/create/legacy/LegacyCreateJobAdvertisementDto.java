...
public class LegacyCreateJobAdvertisementDto {
    ...
    protected LegacyCreateJobAdvertisementDto() {
        // For reflection libs
    }

    public LegacyCreateJobAdvertisementDto(LocalDate publicationStartDate, LocalDate publicationEndDate, String reference, String url, String applicationUrl, LegacyJobDto job, LegacyCompanyDto company, LegacyContactDto contact) {
