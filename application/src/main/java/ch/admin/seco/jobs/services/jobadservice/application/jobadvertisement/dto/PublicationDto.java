...
public class PublicationDto {
    ...
    public PublicationDto(LocalDate startDate, LocalDate endDate, boolean euresDisplay, boolean euresAnonymous, boolean publicDisplay, boolean restrictedDisplay, boolean companyAnonymous) {
