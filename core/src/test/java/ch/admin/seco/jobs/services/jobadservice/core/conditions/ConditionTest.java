...
public class ConditionTest {
    ...
    @Test
    public void shouldReturnAnyNotBlankValue() {
        Condition.anyNotBlank("Should not throw exception", "x");
        Condition.anyNotBlank("Should not throw exception", "   x   ");
        Condition.anyNotBlank("Should not throw exception", null, "", "   ", "   x   ");
    }

    @Test(expected = ConditionException.class)
    public void shouldThrowExceptionForAnyBlankValue() {
        Condition.anyNotBlank(null, "", "   ");
    }
